...
def upgrade() -> None:
    ...
    sa.Column('service_type', sa.Enum('operational_partnership', 'feasibility_study', name='service_type'), nullable=False),
    ...
    op.create_index(op.f('ix_UserFile_file_id'), 'UserFile', ['file_id'], unique=True)
    op.create_index(op.f('ix_UserFile_request_id'), 'UserFile', ['request_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_UserFile_request_id'), table_name='UserFile')
    op.drop_index(op.f('ix_UserFile_file_id'), table_name='UserFile')
